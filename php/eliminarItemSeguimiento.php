...
try {
  ...
  $sql = "delete from seguimiento where id_usuario like :id_usuario and id_item like :id_item and media_type like :media_type";
  ...
  echo "Item eliminado de seguimiento correctamente";
