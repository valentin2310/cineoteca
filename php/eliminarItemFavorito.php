...
try {
  ...
  $sql = "DELETE FROM favorito WHERE id_usuario LIKE :id_usuario AND id_item LIKE :id_item AND media_type LIKE :media_type";
  ...
  echo "Item eliminado de favoritos correctamente";
